...
# Question-028 : The code is supposed to ask the user to enter their name and surname and then it prints out those user submitted values. Instead, the code throws a TypeError. 
...
# Question-031 : Create a function that calculates acceleration given initial velocity v1, final velocity v2, start time t1, and end time t2. 
...
# Question-036 : The following script throws a NameError in the last line saying that c is not defined. 
#				 Please fix the function so that there is no error and the last line is able to 
#				 print out the value of c  (i.e. 1 ).
...
# Question-038 : Please download the words1.txt file from the attachment and then create a function that takes a text file 
#   			 as input and returns the number of words contained in the text file ***

Expected output : 10 

# Question-039 : The following code is supposed to print out the square root of 9, 
...
# Question-040 : The script is supposed to output the cosine of angle 1 radian, but instead it is throwing an error. 
